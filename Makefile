...
SRCS	=config.c base64.c error.c pact.c rxcache.c cache.c wallet.c peerlist.c network.c opcode_callback.c notar.c keypair.c address.c block.c event.c node.c log.c lock.c
